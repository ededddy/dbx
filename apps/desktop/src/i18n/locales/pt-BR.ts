...
export default withEnglishFallback({
  ...
  auth: {
    ...
    enterUsername: "Nome de usuário",
    users: "Contas de usuário",
    usersDescription: "Gerencie as contas que podem entrar nesta instância web",
    ...
    userActionFailed: "A operação falhou",
    deleteUserTitle: "Excluir usuário",
    deleteUserConfirm: "Excluir o usuário {username}? Esta ação não pode ser desfeita.",
  },
  toolbar: {
