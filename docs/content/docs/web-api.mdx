...
| `DBX_SESSION_IDLE_TIMEOUT_MINUTES` | Expire sessions idle longer than this many minutes; unset or `0` keeps sessions until logout or restart. Open SSE streams count as activity, and expired sessions are swept in the background once a minute |
